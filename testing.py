...
data_secondary_30 = pd.read_csv(r"C:\Users\DELL\Downloads\Secondary 30.csv")
data_secondary_50 = pd.read_csv(r"C:\Users\DELL\Downloads\Secondary 50.csv")
data_secondary_100 = pd.read_csv(r"C:\Users\DELL\Downloads\Secondary 100.csv")

data_middle_30 = pd.read_csv(r"C:\Users\DELL\Downloads\Middle 30.csv")
data_middle_50 = pd.read_csv(r"C:\Users\DELL\Downloads\Middle 50.csv")
data_middle_100 = pd.read_csv(r"C:\Users\DELL\Downloads\Middle 100.csv")

data_elementary_30 = pd.read_csv(r"C:\Users\DELL\Downloads\Elementary 30.csv")
data_elementary_50 = pd.read_csv(r"C:\Users\DELL\Downloads\Elementary 50.csv")
data_elementary_100 = pd.read_csv(r"C:\Users\DELL\Downloads\Elementary 100.csv")
...
def plot_mean_bar_chart(data, strength, models):
    ...
    if 'all' in selected_columns:
        ...
        for i, column in enumerate(available_columns[:-1]):
            mean_values = data_section.groupby('class_size')[column].mean()
            ...
            for x, y in zip(mean_values.index, mean_values):
                plt.text(x + i * width - (len(available_columns[:-1]) - 1) * width / 2, y, f'{y:.2f}', ha='center',
        ...
        # Set custom x-axis ticks with adjusted spacing
        # Inside the else block
        # Inside the else block
        plt.xticks([30, 50, 100], labels=['30', '50', '100'])
        plt.tight_layout()
        plt.show()
        ...
        for i, column in enumerate(selected_columns):
            ...
            # Add labels on the bars
            for x, y in zip(mean_values.index, mean_values):
                plt.text(x + i * width - (len(selected_columns) - 1) * width / 2, y, f'{y:.2f}', ha='center',
        ...
        # Set custom x-axis ticks with adjusted spacing
        plt.xticks(mean_values.index + (len(selected_columns) - 1) * width / 2, labels=['30', '50', '100'])
        plt.tight_layout()
        plt.show()
